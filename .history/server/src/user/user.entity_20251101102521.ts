...
export class User extends BaseEntity {
    ...
    @OneToMany(() => Group, (group) => group.owner, { eager: false})
    ownedGroups: Group[];
    ...
    @OneToMany(() => Friendship, (friendship) => friendship.requester, { eager: false})
    friendRequestsSent: Friendship[];

    @OneToMany(() => Friendship, (friendship) => friendship.addressee, { eager: false})
    friendRequestsReceived: Friendship[];

    @OneToMany(() => VisitReview, (visitReview) => visitReview.user, { eager: false})
